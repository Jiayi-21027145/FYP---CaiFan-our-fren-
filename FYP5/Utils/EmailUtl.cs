...
public static class EmailUtl
{
    ...
    private static readonly string EMAIL_ID = config.GetValue<String>("GmailID");
    private static readonly string EMAIL_PW = config.GetValue<String>("GmailPW");

    // Using Microsoft's OUTLOOK
    private static readonly string HOST = "smtp.gmail.com";  // Tested OK Jan '23 PK
    private static readonly int PORT = 465;                         // Tested OK Jan '23 PK
